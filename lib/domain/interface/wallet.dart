...
abstract class WalletRepositoryFacade {
  ...
  Future<ApiResult<WalletHistoryData>> sendWalletBalance(String userUuid, double amount);
  Future<ApiResult<dynamic>> walletTopUp({required double amount, String? token});

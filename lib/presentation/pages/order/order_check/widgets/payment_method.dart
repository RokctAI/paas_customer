...
class PaymentMethods extends ConsumerStatefulWidget {
  ...
  const PaymentMethods({this.payLater, this.tips, this.tipPrice, this.shopEnableCod = true, super.key});
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref
          ...
          .fetchPayments(context, withOutCash: widget.tipPrice != null, shopEnableCod: widget.shopEnableCod);
    });
    super.initState();
  }
                  ...
                  children: [
                    ...
                    (state.payments.isNotEmpty)
                        ...
                        itemBuilder: (context, index) {
                          final bool isPayfast = state.payments[index].tag?.toLowerCase() == "payfast";
                          return SelectItem(
                            onTap: () {
                              event.change(index);
                              if (isPayfast) {

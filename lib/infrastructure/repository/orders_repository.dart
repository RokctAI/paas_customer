...
class OrdersRepository implements OrdersRepositoryFacade {
  ...
  Future<ApiResult<OrderActiveModel>> createOrder(
    ...
    try {
      ...
      final response = await client.post(
        '/api/v1/method/paas.api.order.create_order',
  ...
  Future<ApiResult<OrderPaginateResponse>> getOrders({
    ...
    try {
      ...
      final response = await client.get(
        '/api/v1/method/paas.api.order.list_orders',
  ...
  Future<ApiResult<OrderActiveModel>> getSingleOrder(String orderId) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.get(
        '/api/v1/method/paas.api.order.get_order_details',
  ...
  Future<ApiResult<void>> addReview(
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.order.add_order_review',
        data: data,
      );
  ...
  Future<ApiResult<String>> process(
    ...
    try {
      ...
      var res = await client.post(
        '/api/v1/method/paas.api.payment.initiate_${name.toLowerCase()}_payment',
  ...
  Future<ApiResult<void>> cancelOrder(String orderId) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.order.cancel_order',
  ...
  Future<ApiResult<void>> refundOrder(String orderId, String title) async {
    try {
      ...
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.user.create_order_refund',
        data: data,
      );
      return const ApiResult.success(data: null);
    } catch (e) {
  ...
  Future<ApiResult<RefundOrdersModel>> getRefundOrders(int page) async {
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.get(
        '/api/v1/method/paas.api.user.get_user_order_refunds',
        queryParameters: data,
      );
  ...
  Future<ApiResult<GetCalculateModel>> getCalculate({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.post(
        '/api/v1/method/paas.api.order.get_calculate',
        data: data,
      );
      return ApiResult.success(
  ...
  Future<ApiResult<CouponResponse>> checkCoupon({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.post(
        '/api/v1/method/paas.api.coupon.check_coupon',
        data: data,
      );
  ...
  Future<ApiResult<String>> tipProcess({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.post(
        '/api/v1/method/paas.api.payment.tip_process',
  ...
  Future<ApiResult<CashbackModel>> checkCashback({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.post(
        '/api/v1/method/paas.api.shop.check_cashback',
  ...
  Future<ApiResult<LocalLocation>> getDriverLocation(String deliveryId) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.get(
        '/api/v1/method/paas.api.delivery.get_driver_location',

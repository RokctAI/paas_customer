...
class UserRepository implements UserRepositoryFacade {
  ...
  Future<ApiResult<ProfileResponse>> getProfileDetails() async {
    try {
      ...
      final response = await client.post(
        '/api/v1/method/paas.api.user.get_user_profile',
      );
  ...
  Future<ApiResult<dynamic>> saveLocation({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.user.add_user_address',
        data: address?.toJson(),
      );
  ...
  Future<ApiResult<dynamic>> updateLocation({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.put(
        '/api/v1/method/paas.api.user.update_user_address',
  ...
  Future<ApiResult<dynamic>> deleteAddress({required String id}) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.user.delete_user_address',
        data: {'name': id},
      );
      return const ApiResult.success(data: null);
    } catch (e) {
  ...
  Future<ApiResult<dynamic>> logoutAccount({required String fcm}) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post('/api/v1/method/paas.api.user.logout');
      LocalStorage.logout();
      return const ApiResult.success(data: null);
    } catch (e) {
      return ApiResult.failure(
  ...
  Future<ApiResult<ProfileResponse>> editProfile({
    ...
    try {
      ...
      final response = await client.put(
        '/api/v1/method/paas.api.user.update_user_profile',
  ...
  Future<ApiResult<void>> updateFirebaseToken(String? token) async {
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.user.register_device_token',
        data: data,
      );
      return const ApiResult.success(data: null);
    } catch (e) {
  ...
  Future<ApiResult<ReferralModel>> getReferralDetails() async {
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.post(
        '/api/v1/method/paas.api.user.get_referral_details',
      );
      return ApiResult.success(
  ...
  Future<ApiResult> setActiveAddress({required String id}) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.user.set_active_address',
        data: {'address_id': id},
      );
      return const ApiResult.success(data: null);
    } catch (e) {
  ...
  Future<ApiResult> deleteAccount() async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post('/api/v1/method/paas.api.user.delete_account');
      LocalStorage.logout();
      return const ApiResult.success(data: null);
    } catch (e) {
      return ApiResult.failure(
  ...
  Future<ApiResult<ProfileResponse>> updateProfileImage({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.put(
        '/api/v1/method/paas.api.user.update_profile_image',
  ...
  Future<ApiResult<ProfileResponse>> updatePassword({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.post(
        '/api/v1/method/paas.api.user.update_password',

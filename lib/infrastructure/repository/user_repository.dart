...
class UserRepository implements UserRepositoryFacade {
  ...
  Future<ApiResult<ProfileResponse>> getProfileDetails() async {
    try {
      ...
      final response = await client.get('/api/v1/method/paas.api.get_user_profile');
  ...
  Future<ApiResult<dynamic>> saveLocation({required AddressNewModel? address}) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post('/api/v1/method/paas.api.add_user_address',
          data: address?.toJson());
  ...
  Future<ApiResult<dynamic>> updateLocation({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.put(
        '/api/v1/method/paas.api.update_user_address',
        data: {
          'name': addressId,
  ...
  Future<ApiResult<dynamic>> deleteAddress({required int id}) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.delete_user_address',
        data: {'name': id},
      );
      return const ApiResult.success(data: null);
    } catch (e) {
  ...
  Future<ApiResult<dynamic>> logoutAccount({required String fcm}) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post('/api/v1/method/paas.api.logout');
      LocalStorage.logout();
      return const ApiResult.success(data: null);
    } catch (e) {
      return ApiResult.failure(
  ...
  Future<ApiResult<WalletHistoriesResponse>> getWalletHistories(int page) async {
    ...
    try {
      ...
      final response = await client.get(
        '/api/v1/method/paas.api.get_wallet_history',
  ...
  Future<ApiResult<ReferralModel>> getReferralDetails() async {
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.get('/api/v1/method/paas.api.get_referral_details');
      return ApiResult.success(
  ...
  Future<ApiResult> setActiveAddress({required int id}) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post(
        '/api/v1/method/paas.api.set_active_address',
        data: {'address_id': id},
      );
      return const ApiResult.success(data: null);
    } catch (e) {
  ...
  Future<ApiResult> deleteAccount() async {
    try {
      final client = dioHttp.client(requireAuth: true);
      await client.post('/api/v1/method/paas.api.delete_account');
      LocalStorage.logout();
      return const ApiResult.success(data: null);
    } catch (e) {
      return ApiResult.failure(
  ...
  Future<ApiResult<ProfileResponse>> updateProfileImage({
    ...
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.put(
        '/api/v1/method/paas.api.update_profile_image',
        data: {
          'image_url': imageUrl,
        },
      );
  ...
  Future<ApiResult<ProfileResponse>> updatePassword({
    ...
    try {
      ...
      final response = await client.post(
        '/api/v1/method/paas.api.update_password',
        data: {
          'password': password,
        },
      );
  ...
  Future<dynamic> searchUser({required String name, required int page}) async {
    try {
      final client = dioHttp.client(requireAuth: true);
      final response = await client.get(
        '/api/v1/method/paas.api.search_user',
        queryParameters: {
          'name': name,
          'page': page,
        },

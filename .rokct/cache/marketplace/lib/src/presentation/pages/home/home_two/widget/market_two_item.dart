...
import 'package:marketplace_sdk/src/presentation/pages/home/home_two/widget/two_bonus_discount.dart';
...
class MarketTwoItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        AppRoutes.I.pushShopRoute(context, shopId: (shop.id ?? 0).toString(), shop: shop);
      },
      child: isShop
          ? _shopItem()
          : Container(

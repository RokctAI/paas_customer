...
mixin _$FilterState {
 ...
 FilterModel? get filterModel; bool get freeDelivery; bool get deals; bool get open; int get shopCount; double get endPrice; double get startPrice; bool get isLoading; bool get isTagLoading; bool get isShopLoading; bool get isAllShopsLoading; RangeValues get rangeValues; List<ShopData> get shops; List<TakeModel> get tags; List<int> get prices; List<ShopData> get allShops;
...
@useResult
$Res call({
 FilterModel? filterModel, bool freeDelivery, bool deals, bool open, int shopCount, double endPrice, double startPrice, bool isLoading, bool isTagLoading, bool isShopLoading, bool isAllShopsLoading, RangeValues rangeValues, List<ShopData> shops, List<TakeModel> tags, List<int> prices, List<ShopData> allShops
});
...
/// Create a copy of FilterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? filterModel = freezed,Object? freeDelivery = null,Object? deals = null,Object? open = null,Object? shopCount = null,Object? endPrice = null,Object? startPrice = null,Object? isLoading = null,Object? isTagLoading = null,Object? isShopLoading = null,Object? isAllShopsLoading = null,Object? rangeValues = null,Object? shops = null,Object? tags = null,Object? prices = null,Object? allShops = null,}) {
...
as bool,isAllShopsLoading: null == isAllShopsLoading ? _self.isAllShopsLoading : isAllShopsLoading // ignore: cast_nullable_to_non_nullable
...
as List<int>,allShops: null == allShops ? _self.allShops : allShops // ignore: cast_nullable_to_non_nullable
as List<ShopData>,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( FilterModel? filterModel,  bool freeDelivery,  bool deals,  bool open,  int shopCount,  double endPrice,  double startPrice,  bool isLoading,  bool isTagLoading,  bool isShopLoading,  bool isAllShopsLoading,  RangeValues rangeValues,  List<ShopData> shops,  List<TakeModel> tags,  List<int> prices,  List<ShopData> allShops)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FilterState() when $default != null:
return $default(_that.filterModel,_that.freeDelivery,_that.deals,_that.open,_that.shopCount,_that.endPrice,_that.startPrice,_that.isLoading,_that.isTagLoading,_that.isShopLoading,_that.isAllShopsLoading,_that.rangeValues,_that.shops,_that.tags,_that.prices,_that.allShops);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( FilterModel? filterModel,  bool freeDelivery,  bool deals,  bool open,  int shopCount,  double endPrice,  double startPrice,  bool isLoading,  bool isTagLoading,  bool isShopLoading,  bool isAllShopsLoading,  RangeValues rangeValues,  List<ShopData> shops,  List<TakeModel> tags,  List<int> prices,  List<ShopData> allShops)  $default,) {final _that = this;
switch (_that) {
case _FilterState():
return $default(_that.filterModel,_that.freeDelivery,_that.deals,_that.open,_that.shopCount,_that.endPrice,_that.startPrice,_that.isLoading,_that.isTagLoading,_that.isShopLoading,_that.isAllShopsLoading,_that.rangeValues,_that.shops,_that.tags,_that.prices,_that.allShops);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( FilterModel? filterModel,  bool freeDelivery,  bool deals,  bool open,  int shopCount,  double endPrice,  double startPrice,  bool isLoading,  bool isTagLoading,  bool isShopLoading,  bool isAllShopsLoading,  RangeValues rangeValues,  List<ShopData> shops,  List<TakeModel> tags,  List<int> prices,  List<ShopData> allShops)?  $default,) {final _that = this;
switch (_that) {
case _FilterState() when $default != null:
return $default(_that.filterModel,_that.freeDelivery,_that.deals,_that.open,_that.shopCount,_that.endPrice,_that.startPrice,_that.isLoading,_that.isTagLoading,_that.isShopLoading,_that.isAllShopsLoading,_that.rangeValues,_that.shops,_that.tags,_that.prices,_that.allShops);case _:
  return null;
...
class _FilterState extends FilterState {
  const _FilterState({this.filterModel = null, this.freeDelivery = false, this.deals = false, this.open = true, this.shopCount = 0, this.endPrice = 100, this.startPrice = 1, this.isLoading = false, this.isTagLoading = false, this.isShopLoading = true, this.isAllShopsLoading = true, this.rangeValues = const RangeValues(1, 100), final  List<ShopData> shops = const [], final  List<TakeModel> tags = const [], final  List<int> prices = const [], final  List<ShopData> allShops = const []}): _shops = shops,_tags = tags,_prices = prices,_allShops = allShops,super._();
...
@override@JsonKey() final  bool isAllShopsLoading;
...
@override@JsonKey() List<ShopData> get allShops {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FilterState&&(identical(other.filterModel, filterModel) || other.filterModel == filterModel)&&(identical(other.freeDelivery, freeDelivery) || other.freeDelivery == freeDelivery)&&(identical(other.deals, deals) || other.deals == deals)&&(identical(other.open, open) || other.open == open)&&(identical(other.shopCount, shopCount) || other.shopCount == shopCount)&&(identical(other.endPrice, endPrice) || other.endPrice == endPrice)&&(identical(other.startPrice, startPrice) || other.startPrice == startPrice)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isTagLoading, isTagLoading) || other.isTagLoading == isTagLoading)&&(identical(other.isShopLoading, isShopLoading) || other.isShopLoading == isShopLoading)&&(identical(other.isAllShopsLoading, isAllShopsLoading) || other.isAllShopsLoading == isAllShopsLoading)&&(identical(other.rangeValues, rangeValues) || other.rangeValues == rangeValues)&&const DeepCollectionEquality().equals(other._shops, _shops)&&const DeepCollectionEquality().equals(other._tags, _tags)&&const DeepCollectionEquality().equals(other._prices, _prices)&&const DeepCollectionEquality().equals(other._allShops, _allShops));
}


@override
int get hashCode => Object.hash(runtimeType,filterModel,freeDelivery,deals,open,shopCount,endPrice,startPrice,isLoading,isTagLoading,isShopLoading,isAllShopsLoading,rangeValues,const DeepCollectionEquality().hash(_shops),const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_prices),const DeepCollectionEquality().hash(_allShops));
...
as List<int>,allShops: null == allShops ? _self._allShops : allShops // ignore: cast_nullable_to_non_nullable
as List<ShopData>,
  ));
}

          ...
          children: [
            AppHelpers.getReservationEnable()
                ? _buildSquareButton(
                    ...
                    // booking_sdk 1.1.0 owns the reservation flow: push its
                    // /reservations route by path (the generated route
                    // class lives in the host, ADR-005). A compose without
                    // booking_sdk fails through onFailure, not a throw.

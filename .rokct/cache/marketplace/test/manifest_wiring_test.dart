...
void main() {
  ...
  const expectedRoutes = <String, String>{
    ...
    '/recommended_one': 'RecommendedOneRoute',
    '/recommended_two': 'RecommendedTwoRoute',
    '/recommended_three': 'RecommendedThreeRoute',
    '/help': 'HelpRoute',
    '/result_filter': 'ResultFilterRoute',
    '/create_shop': 'CreateShopRoute',
    '/shops_banner': 'ShopsBannerRoute',
    '/share_referral': 'ShareReferralRoute',
    '/share_referral_faq': 'ShareReferralFaqRoute',
    '/notification_list_page': 'NotificationListRoute',
    '/like_page': 'LikeRoute',
    '/address_list_page': 'AddressListRoute',
  };
  const expectedSeams = <String>[
    'replaceMainRoute',
    'pushProfileRoute',
    'pushSearchRoute',
    'pushRecommendedRoute',
    'pushRecommendedOneRoute',
    'pushRecommendedTwoRoute',
    'pushRecommendedThreeRoute',
    'pushHelpRoute',
    'pushResultFilterRoute',
    'pushCreateShopRoute',
    'pushShopsBannerRoute',
    'pushShareReferralRoute',
    'pushShareReferralFaqRoute',
    'pushNotificationListRoute',
    'pushLikeRoute',
    'pushAddressListRoute',
  ];

  group('marketplace_sdk manifest route wiring', () {
